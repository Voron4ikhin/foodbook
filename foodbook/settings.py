...
SECRET_KEY = 'django-insecure-rba)ik&kj2+3bs38=x(on329-s#k7ch*j#u^cz-g%7tc^l3^=a'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'profiles.context_processor.invitation_received_no',
                'profiles.context_processor.invitation_sended_no'
            ],
        },
    },
]
